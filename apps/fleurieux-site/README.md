...
git clone https://github.com/Stan69000/workspace.git
cd workspace

# 2. Variables d'env
cp apps/fleurieux-site/.env.example apps/fleurieux-site/.env
...
pnpm --filter fleurieux-site db:push    # Crée les tables
pnpm --filter fleurieux-site db:seed    # Données de démo

# 5. Lancer
pnpm --filter fleurieux-site dev
```
