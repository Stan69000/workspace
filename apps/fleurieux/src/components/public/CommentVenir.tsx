...
export function CommentVenir({ lat, lon, nom, adresse }: Props) {
  ...
  return (
    <div className="space-y-3">
      <div className="h-56 w-full overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700">
      ...
      {adresse && <p className="text-sm text-gray-600 dark:text-gray-400">📍 {adresse}</p>}
      <a
      ...
      >
        🗺️ Itinéraire via OpenStreetMap
      </a>
    </div>
  )
}
